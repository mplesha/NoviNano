...
function integral_review_notice() {
    ...
    if ( ! get_user_meta($user_id, 'integral_review_nag_ignore') ) { ?>
        ...
        <a href="<?php echo esc_url( admin_url( '?integral_review_nag_ignore=0' ) ); ?>" style="text-decoration: none;" class="notice-dismiss"><span class="screen-reader-text">Dismiss this notice</span></a>
        </div>
    <?php }
}
