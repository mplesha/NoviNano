...
if ( ! class_exists( 'Blockchain_Lite_Onboarding_Page' ) ) {
	...
	class Blockchain_Lite_Onboarding_Page {
		...
		public function onboarding_notice() {
			...
			?>
			<div class="notice notice-info is-dismissible blockchain-lite-onboarding-notice">
				<p>
					<?php
			...
			wp_enqueue_script( 'blockchain-lite-onboarding-notice', get_template_directory_uri() . '/inc/onboarding/js/onboarding-notice.js', array(), $this->theme_version, true );
		...
		public function enqueue_admin_styles() {
			...
			wp_enqueue_style( 'blockchain-lite-onboarding', get_template_directory_uri() . '/inc/onboarding/css/onboarding-styles.css', array(), $this->theme_version );

			wp_enqueue_script( 'blockchain-lite-onboarding', get_template_directory_uri() . '/inc/onboarding/js/onboarding.js', array(
				'plugin-install',
				'updates',
		...
		public function sample_content() {
			...
			if ( in_array( $check['one-click-demo-import'], array( 'install-plugin', 'activate' ), true ) ) {
				...
				<div class="blockchain-lite-onboarding-box blockchain-lite-onboarding-box-warning">
					...
					<p><?php esc_html_e( 'You need to install and activate One Click Demo Import before proceeding.', 'blockchain-lite' ); ?></p>
					<p><a class="button button-primary" href="<?php echo esc_url( get_admin_url( '', 'themes.php?page=' . $this->theme_slug . '-onboard' ) . '&tab=recommended_plugins' ); ?>"><?php esc_html_e( 'Click here to do it now.', 'blockchain-lite' ); ?></a></p>
				</div>
				<?php
			} else {
				?>
					...
					<div class="col">
						<div class="blockchain-lite-onboarding-box blockchain-lite-onboarding-box-warning">
							...
							<div class="plugin-card-<?php echo esc_attr( $slug ); ?>">
								...
								<p><a href="<?php echo esc_url( $link ); ?>" class="install-now button ajax-install-plugin" data-plugin-slug="<?php echo esc_attr( $slug ); ?>"><?php esc_html_e( 'Install &amp; activate ', 'blockchain-lite' ); ?></a></p>
							</div>	
						</div>
					</div>	
					<?php
					...
					<div class="col">
						<div class="blockchain-lite-onboarding-box blockchain-lite-onboarding-box-warning">
							...
							<div class="plugin-card-<?php echo esc_attr( $slug ); ?>">
								...
								<p><a data-slug="<?php echo esc_attr( $slug ); ?>" href="<?php echo esc_url( $link ); ?>" class="install-now button"><?php esc_html_e( 'Install &amp; activate ', 'blockchain-lite' ); ?></a></p>
							</div>	
						</div>
					</div>	
					<?php
					...
					<div class="col">
						<div class="blockchain-lite-onboarding-box blockchain-lite-onboarding-box-info">
							...
							<div class="plugin-card-<?php echo esc_attr( $slug ); ?>">
								...
								<p><a data-slug="<?php echo esc_attr( $slug ); ?>" href="<?php echo esc_url( $link ); ?>" class="activate-now button button-primary"><?php esc_html_e( 'Activate ', 'blockchain-lite' ); ?></a></p>
							</div>	
						</div>
					</div>
					<?php
		...
		public function install_plugin() {
			...
			// Verify nonce.
			if ( ! isset( $_POST['onboarding_nonce'] ) || ! wp_verify_nonce( sanitize_key( $_POST['onboarding_nonce'] ), 'onboarding_nonce' ) ) { // Input var okay.
				die( 'Permission denied' );
			}

			$plugin_slug = ! empty( $_POST['plugin_slug'] ) ? sanitize_key( $_POST['plugin_slug'] ) : ''; // Input var okay.
...
//						),
	...
	} //Blockchain_Lite_Onboarding_Page
}
