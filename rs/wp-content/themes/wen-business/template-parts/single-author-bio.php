<div class="authorbox <?php echo ( 1 != get_option( 'show_avatars' ) ) ? 'no-author-avatar' : ''; ?>">
  ...
  <div class="author-info">
    <h4 class="author-header"><?php _e( 'Written by', 'wen-business' ); ?>&nbsp;<?php  the_author_posts_link(); ?></h4>
    ...
    <?php if ( ! empty( $user_url ) ): ?>
      <div class="author-footer"><a href="<?php echo esc_url( $user_url ); ?>" target="_blank"><?php _e( 'Website', 'wen-business' ); ?></a></div>
    <?php endif ?>
  </div>
</div>
