...
class Companion
{
    ...
    public function setPageContent($data, $filter_context)
    {
        ...
        update_option('mesmerize_colors_cached_style', '', 'yes');
        update_option('mesmerize_cached_kirki_style_mesmerize', '', 'yes');
        update_option('mesmerize_cached_kirki_style_mesmerize-pro', '', 'yes');
