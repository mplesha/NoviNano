...
{
    $copyrightText = __('Copyright 2018 Novinano Inc.', 'mesmerize');
    ...
    $copyright = '<p '  . $previewAtts . ' class="copyright">&copy;&nbsp; Copyright' . "&nbsp;" . date_i18n(__('Y', 'mesmerize')) . '&nbsp;' . esc_html(get_bloginfo('name')) . '&nbsp;Inc. </p>';
