VisualDeveloper.Utility.SVGCheckbox = {
  ...
  InstanceObject : {
    ...
    _init : function() {
      ...
      if(this.formObject.hasClass('visual-developer-utility-svg-checkbox-option-cross')) {
      ...
      } else if(this.formObject.hasClass('visual-developer-utility-svg-checkbox-option-fill')) {
      ...
      } else if(this.formObject.hasClass('visual-developer-utility-svg-checkbox-option-checkmark')) {
      ...
      } else if(this.formObject.hasClass('visual-developer-utility-svg-checkbox-option-circle')) {
      ...
      } else if(this.formObject.hasClass('visual-developer-utility-svg-checkbox-option-boxfill')) {
      ...
      } else if(this.formObject.hasClass('visual-developer-utility-svg-checkbox-option-swirl')) {
      ...
      } else if(this.formObject.hasClass('visual-developer-utility-svg-checkbox-option-diagonal')) {
      ...
      } else if(this.formObject.hasClass('visual-developer-utility-svg-checkbox-option-list')) {
