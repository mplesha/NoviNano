 ...
 */
class Cactus_WXR_Parser {
	function parse( $file ) {
		// Attempt to use proper XML parsers first
		if ( extension_loaded( 'simplexml' ) ) {
			$parser = new Cactus_WXR_Parser_SimpleXML;
			...
			$parser = new Cactus_WXR_Parser_XML;
			$result = $parser->parse( $file );
		...
		$parser = new Cactus_WXR_Parser_Regex;
 ...
 */
class Cactus_WXR_Parser_SimpleXML {
	function parse( $file ) {
